...
namespace coin {
    ...
    class block : public data_buffer
    {
        public:
             ...
             * The current version.
             */
            enum { current_version = version_bits::top_bits };
        	...
        	/**
          	 * Gets the transaction has at the given index.
             * @param index The index.
             */
            const sha256 &
            	get_tranaction_hash(const std::uint32_t & index) const
            ;
             ...
             * @param index The block_index.
             */
            bool disconnect_block_2(db_tx & tx_db, block_index * index);
            ...
            /**
             * If true the block header passes basic validity checks such
             * as Proof-of-Work matches claimed bits and timestamp is
             * not from the future.
             */
            bool is_header_valid();
        
        	/**
             * Sets the chain header synchronization height.
             */
        	void set_peer_headers_first_sync_height(const std::int32_t & val);
        
            /**
             * The chain header synchronisation height.
             */
            const std::int32_t & peer_headers_first_sync_height() const;
             ...
             * @param index_new The block_index.
             */
            bool set_best_chain_2(db_tx & tx_db, block_index * index_new);
        ...
        private:
             ...
             * The chain header synchronisation height.
             */
            std::int32_t m_peer_headers_first_sync_height;
