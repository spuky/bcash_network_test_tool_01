...
namespace coin {
    ...
    class rpc_connection : public std::enable_shared_from_this<rpc_connection>
    {
        ...
        protected:
            ...
            /**
             * Performs a addendpoint operation.
             * @param request The json_rpc_request_t.
             */
            json_rpc_response_t json_addendpoint(
                const json_rpc_request_t & request
            );
        
            /**
             * Performs a banip operation.
             * @param request The json_rpc_request_t.
             */
            json_rpc_response_t json_banip(
                const json_rpc_request_t & request
            );
             ...
             * @param request The json_rpc_request_t.
             */
            json_rpc_response_t json_getblockchaininfo(
                const json_rpc_request_t & request
            );
            ...
            /**
             * Encodes gettxoutsetinfo data into JSON format.
             * @param request The json_rpc_request_t.
             */
            json_rpc_response_t json_gettxoutsetinfo(
                const json_rpc_request_t & request
            );
            ...
            /**
             * Encodes setnetworktcpbandwidthmaximum data into JSON format.
             * @param request The json_rpc_request_t.
             */
            json_rpc_response_t json_setnetworktcpbandwidthmaximum(
                const json_rpc_request_t & request
            );
