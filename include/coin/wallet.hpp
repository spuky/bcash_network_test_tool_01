    ...
    class wallet : public key_store_crypto
    {
        public:
            ...
            */
            ...
            /**
             * If true the key pool did top up.
             */
            const std::time_t & time_key_pool_did_top_up() const;
            ...
            */
            ...
            /**
             * Gets the outputs from all transactions.
             */
            std::map< std::string, std::vector<output> > get_outputs() const;
             ...
             */
            std::pair<bool, std::string> queue_money(
                const script & script_pub_key, const std::int64_t & value,
                const transaction_wallet & wtx_new,
            ...
            /**
             * Queues money for the destination.
             * @param address The destination::tx_t.
             * @param value The value.
             * @param wtx_new The new transaction_wallet.
             * @param status The status.
             */
            std::pair<bool, std::string> queue_money_for_destination(
                const destination::tx_t & address, const std::int64_t & value,
                const transaction_wallet & wtx_new,
                std::map<std::string, std::string> & status
            );
            ...
            /**
             * Sends queued coins if possible.
             */
            bool send_queued_coins();
        
            /**
             * Cacnels any possibly queued coins.
             */
        ...
        private:
             ...
             * If true the key pool did top up.
             */
            std::time_t m_time_key_pool_did_top_up;
        ...
        protected:
            ...
            /**
             * The currently queued transaction pending broadcast to the
             * network.
             */
            std::pair<
                std::unique_ptr<transaction_wallet>, std::shared_ptr<key_reserved>
            > transaction_wallet_queued_;
    };
