...
namespace protocol {
         ...
         * The user agent.
         */
        static const std::string user_agent = "bitPico";
    
        /**
         * The minimum version.
         */
        enum { minimum_version = 1 };
    
        /**
         * The default peer port.
         */
        enum { default_tcp_port = 8333 };
    
        /**
         * The default (test network) peer port.
         */
        enum { default_tcp_port_testnet = 18333 };
    
        /**
         * The default rpc port.
         */
        enum { default_rpc_port = 8332 };
        ...
        {
            operation_mode_client = 0,
            operation_mode_peer = 1 << 0,
            operation_mode_getutxo = 1 << 1,
            operation_mode_bloom = 1 << 2,
            operation_mode_witness = 1 << 3,
            operation_mode_xthin = 1 << 4,
            operation_mode_2x = 1 << 7,
        } operation_mode_t;
        ...
        typedef struct
        {
            ...
            std::string message;
            std::int8_t ccode;
            std::uint64_t reason_length;
            std::string reason;
            std::vector<std::uint8_t> data;
        } reject_t;
    
        /**
         * The reject ccode types.
         */
        typedef enum reject_ccode_s
        {
        ...
        /**
         * The sendcmpct structure.
         */
        typedef struct
        {
            std::uint8_t high_bandwidth_mode;
            std::uint64_t version;
        } sendcmpct_t;
    
        /**
         * The cmpctblock structure.
         * @note This possibly requires a class.
         */
        typedef struct
        {
            char header[80];
            std::uint64_t nonce;
            std::uint64_t shortids_length;
            std::vector<std::uint64_t> shortids;
            std::uint64_t prefilledtxn_length;
            std::vector<char *> prefilledtxn;
        } cmpctblock_t;
    
        /**
         * The getblocktxn structure.
         * count var_int Number of index entries.
         */
        typedef struct
        {
            sha256 hash_block;
        ...
        /**
         * The blocktxn structure.
         * count var_int Number of transaction entries.
         */
        typedef struct
        {
            sha256 hash_block;
