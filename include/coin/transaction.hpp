...
namespace coin {
    ...
    class transaction : public data_buffer
    {
        public:
             ...
             */
            enum { confirmations = 6 };
        
            /**
             * The maximum serialized size of a standard transaction.
             * @note This is defined as MAX_STANDARD_TX_SIZE in the Satoshi
             * codebase.
             */
            enum { standard_size_maximum = 100000 };
             ...
             * @param encode_time If true the time is encoded.
             */
            void encode(
                const bool & encode_version = true,
                const bool & encode_time = false
            );
             ...
             * Decodes
             * @param buffer The data_buffer.
             * @param decode_time If true the time is decoded.
             */
            bool decode(
                data_buffer & buffer, const bool & decode_time = false
            );
             ...
             * are_inputs_standard
             */
            bool are_inputs_standard_2() const;
             ...
             * @param inputs The previous transactions.
             */
            std::int64_t get_value_in_2() const;
             ...
             * get_p2sh_sig_op_count
             */
            std::uint32_t get_p2sh_sig_op_count_2() const;
             ...
             */
            std::pair<bool, std::string> accept_to_transaction_pool_2(
                bool * missing_inputs = nullptr
            );
			...
			/**
   			 * Updates coins in the coins_cache at the given height.
       		 * @param cache The coins_cache.
            ...
            /**
             * If true we have all inputs in the coins_database.
			 */
