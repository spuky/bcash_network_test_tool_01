...
std::string filesystem::g_bundle_id = constants::client_name;
...
{
    std::string bundle_id = "bitcoinPico";
...
std::string filesystem::home_path()
{
    ...
    std::string bundle_id = "com.bitpico.bitpico";
