...
void address_manager::start()
{
    ...
    {
        log_error(
            "Address manager caught exception, what = " << e.what() << "."
        );
    }
}
    ...
    )
{
    ...
    else
    {
        ...
        auto nid1 = random_ids_[first];
        auto nid2 = random_ids_[second];

		/**
   		 * @note These can become off; not high priority.
      	 */
#if 0
